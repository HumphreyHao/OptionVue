...
export default {
  ...
  data() {
    return {
      ...
      rawRows: [
        [
          "Manoj", "24", "Software Developer", "1997", 0.2
        ],
        [
          "John", "26", "Lawyer", "1995", 0.3
        ],
        [
          "Lily", "34", "Saleswoman", "1987", 0
        ],
        [
          "Rachel", "34", "Saleswoman", "1987", 0
        ],
        [
          "Ross", "34", "Barber", "1987", 0
        ],
        [
          "Chandler", "30", "Salesman", "1991", 0
        ]
      ],
      rows: [],
      columns: [
